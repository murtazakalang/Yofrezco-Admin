...
CustomDocument.getInitialProps = async (ctx) => {
  ...
  // 🛠 Fetch analytics config server-side with timeout to prevent blocking
  let analyticsConfig = {};
  try {
    const baseUrl =
    ...
    // Silent fail - analytics won't load but page will render
    console.warn("Analytics config timeout or error - page will load without analytics:", err.message);
  }
