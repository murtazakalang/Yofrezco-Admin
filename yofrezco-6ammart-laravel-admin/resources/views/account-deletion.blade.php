    ...
    <section class="about-section py-5 position-relative">
        <div class=" container contact-container">
            ...
            <div class="section-header">
                ...
                <div class="text">
                    {{ translate('If you wish to delete your Yofrezco account, please provide your email and account details below and submit a request.') }}<br><br>
                    <strong>{{ translate('Data Deletion Confirmation:') }}</strong> {{ translate('Upon receiving and verifying your request, we will permanently delete your account and all associated personal data stored in our database in accordance with our terms.') }}<br><br>
                    <strong>{{ translate('Note:') }}</strong> {{ translate('You can also instantly and automatically delete your account inside the Yofrezco app by navigating to Profile > Delete Account.') }}
                </div>
            </div>
            ...
            <div class="contact-img">
                <img src="{{ \App\CentralLogics\Helpers::get_full_url('contact_us_image', $contact_us_image?->value, data_get($contact_us_image, 'storage.0.value', 'public')) }}" alt="">
            </div>
                ...
                <div class="col-lg-6">
                    <form class="contact-form-wrapper" method="post" action="{{route('send-message')}}" id="form-id">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-12">
                                <input type="text" required name="subject" value="Account Deletion Request" readonly class="form-control form--control">
                            </div>
                            <div class="col-sm-12">
