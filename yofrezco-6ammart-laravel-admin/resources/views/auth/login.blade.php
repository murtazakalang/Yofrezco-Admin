...
<div 
    class="auth-wrapper-left"
    style="
        background-image: url('{{ asset('/public/assets/admin/css/images/admin-login-bg.jpeg') }}');
        ...
        <div class="auth-wrapper-right">
            ...
            <div class="auth-wrapper-form">
                ...
                <form class="" action="{{route('login_post')}}" method="post" id="form-id">
                    ...
                    <button type="submit" style="background:#012afe" class="btn btn-lg btn-block btn--primary mt-xxl-3" id="signInBtn">{{translate('messages.login')}}</button>
                </form>
                <!-- End Form -->
