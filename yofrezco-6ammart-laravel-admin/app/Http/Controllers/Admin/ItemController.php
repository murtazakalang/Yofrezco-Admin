...
class ItemController extends Controller
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $product->choice_options = $product->choice_options ?? json_encode([]);
        $product->variations = $product->variations ?? json_encode([]);
        $product->add_ons = $product->add_ons ?? json_encode([]);
        $product->attributes = $product->attributes ?? json_encode([]);
        $product->images = $product->images ?? json_encode([]);
